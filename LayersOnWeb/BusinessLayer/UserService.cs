...
namespace BusinessLayer
{
    public class UserService : IUserService
    {
        ...
        public async Task<UserModel> DeleteUser(string userid)
        {
            ...
            user1.Id = Guid.Parse(user.Id);
            return user1;

        }

        public async Task<UserModel> UpdateUser(string id, string username)
        {
            ...
            UserModel user1 = new UserModel();
            user1.Username = userToUpdate.UserName;
            user1.Id = Guid.Parse(userToUpdate.Id);
            return user1;
