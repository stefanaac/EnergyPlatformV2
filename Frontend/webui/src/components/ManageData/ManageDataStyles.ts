...
export const manageDataContainerClassName: string = mergeStyles({
...
export const manageDataTitleStyles = {
    marginLeft: '24vw',
    fontFamily: 'Raleway',
    fontStyle: 'normal',
    marginTop: '7vh',
...
export const manageDataTitleLineStyles = {
...
export const dataListDivStyles = {
    marginLeft: '30vw',
    marginTop: '5vh',
    minWidth: '30px',
    minHeight: '1px',
...
export const dataListStyles: Partial<IDetailsListStyles> = {
    root: {
        backgroundColor: PAGE_BACKGROUND_COLOR,
        overflow: 'hidden',
        selectors: {
