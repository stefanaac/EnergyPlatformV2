...
export const manageDevicesContainerClassName: string = mergeStyles({
...
export const manageDevicesTitleStyles = {
    marginLeft: '24vw',
    fontFamily: 'Raleway',
    fontStyle: 'normal',
    marginTop: '7vh',
...
export const manageDevicesTitleLineStyles = {
...
export const deviceListDivStyles = {
    marginLeft: '20vw',
    marginTop: '5vh',
    minWidth: '30px',
    minHeight: '1px',
...
export const deviceListStyles: Partial<IDetailsListStyles> = {
    root: {
        backgroundColor: PAGE_BACKGROUND_COLOR,
        overflow: 'hidden',
        selectors: {
